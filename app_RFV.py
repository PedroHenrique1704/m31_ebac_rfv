...
def main():
    ...
    st.sidebar.write("## Arquivo exemplo:")

    # Ler o CSV como DataFrame
    data_csv = pd.read_csv("./input/dados.csv")

    # Converter o DataFrame para CSV (em string)
    csv_string = data_csv.to_csv(index=False, encoding="utf-8")

    # Criar botão de download com os dados corretos
    st.sidebar.download_button(
        label="Dataframe Exemplo (csv)", 
        data=csv_string, 
